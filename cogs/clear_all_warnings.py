...
class WarnCog(commands.Cog):
    ...
    @app_commands.command(name="clear_all_warnings", description="Clear all warnings for a user")
    async def clear_all_warnings_slash(self, interaction: discord.Interaction, user: discord.Member):
        user_id = str(user.id)
